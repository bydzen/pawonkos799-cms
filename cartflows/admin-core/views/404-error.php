...
<div class="wcf-no-page-found-wrapper">
	<div class="content-container" style="text-align:center;">
		...
		<p class="not-found-pre-sub-title"><?php esc_attr_e( '404 ERROR', 'cartflows' ); ?></p>
		<h2 class="not-found-title"><?php esc_attr_e( 'Page Not Found.', 'cartflows' ); ?></h2>
		<div class="not-found-message"><p><?php esc_attr_e( 'Sorry, we couldn’t find the page you’re looking for.', 'cartflows' ); ?></p></div>
		<a href="<?php echo esc_url_raw( admin_url( 'admin.php?page=cartflows' ) ); ?>" class="not-found-action-link"><?php esc_attr_e( 'Go back home', 'cartflows' ); ?> <span class="dashicons dashicons-arrow-right-alt"></span></a>
	</div>
</div>
<p>
</p>
